    ...
    <div class="flex-1">
      <div class="container mx-auto p-8">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="time" id="time" class="w-full p-2 border rounded-md" placeholder="Enter Time (HH:MM)" pattern="^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" value="{{ old('time') ?? $schedule['time']}}">
