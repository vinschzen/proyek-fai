...
<div class="w-full bg-center bg-cover" style="background-image: url(https://images.pexels.com/photos/2707756/pexels-photo-2707756.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260);">
    ...
    <div class="grid grid-cols-4 gap-2">
        ...
        <div>
            <a href="{{ route('toPlay', $play['id'] )}}">
                <img src="{{ asset('storage/' . $play['poster']) }}" alt="{{ $play['title'] }} Poster" style="width: 200px" class="cursor-pointer image-modal-trigger" data-image-url="{{ asset('storage/' . $play['poster']) }}">
            </a>
            {{$play['title']}}
        </div>
        @endforeach
