        ...
        <div class="bg-white rounded p-4 shadow-md mb-4">
          <div class="grid grid-cols-7">
              <div class="col-span-1 p-5">
                  <img src="{{ asset('storage/' . $play['poster']) }}" alt="{{ $play['title'] }} Poster" class="object-cover mb-4">
              </div>
            ...
            @foreach ($schedules as $schedule)
                ...
                <tr class="hover:bg-gray-100 transition duration-300 ease-in-out hover:bg-gray-200">
                    ...
                    <td class="p-3 border-b text-left">
                      ...
                      @else
                        <a href="{{ route('toCheckout', $schedule['id']) }}" class="bg-green-500 text-white p-2 rounded hover:bg-green-700">Tickets</a>
                      @endif
                    </td>
